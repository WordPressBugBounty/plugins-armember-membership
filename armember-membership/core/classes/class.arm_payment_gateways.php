	...
	class ARM_payment_gateways_Lite {
		...
		function arm_bank_transfer_payment_gateway_action( $payment_gateway, $payment_gateway_options, $posted_data, $entry_id = 0 ) {
			...
			if ( $payment_gateway == 'bank_transfer' ) {
				do_action('arm_payment_log_entry', 'bank_transfer', 'Bank Transfer Posted Data', 'armember', $posted_data, $arm_lite_debug_payment_log_id);
				...
				if ( ! empty( $entry_data ) ) {
					...
					do_action('arm_payment_log_entry', 'bank_transfer', 'Bank Transfer Entry values', 'armember', $entry_values, $arm_lite_debug_payment_log_id);
